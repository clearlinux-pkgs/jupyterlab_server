...
Version  : 2.7.1
Release  : 52
URL      : https://files.pythonhosted.org/packages/15/b4/8f08da630417894f660ca728f475b4d542f5e86f8fdbbb28c92028a663bf/jupyterlab_server-2.7.1.tar.gz
Source0  : https://files.pythonhosted.org/packages/15/b4/8f08da630417894f660ca728f475b4d542f5e86f8fdbbb28c92028a663bf/jupyterlab_server-2.7.1.tar.gz
...
%prep
%setup -q -n jupyterlab_server-2.7.1
cd %{_builddir}/jupyterlab_server-2.7.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1629234074
...
cp %{_builddir}/jupyterlab_server-2.7.1/LICENSE %{buildroot}/usr/share/package-licenses/jupyterlab_server/5c2668cefc1e214f589e49594127f9f79574de44
