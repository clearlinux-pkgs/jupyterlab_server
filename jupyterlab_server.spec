...
Source0  : https://files.pythonhosted.org/packages/a1/11/a4e01b3b73e026b543935c17a13c4c524ed6150df800011b16ee32eff062/jupyterlab_server-2.7.0.tar.gz
...
%prep
%setup -q -n jupyterlab_server-2.7.0
cd %{_builddir}/jupyterlab_server-2.7.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1628706590
...
cp %{_builddir}/jupyterlab_server-2.7.0/LICENSE %{buildroot}/usr/share/package-licenses/jupyterlab_server/5c2668cefc1e214f589e49594127f9f79574de44
