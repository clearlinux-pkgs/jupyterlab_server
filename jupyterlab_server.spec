...
Source0  : https://files.pythonhosted.org/packages/b4/02/792f4b2d957235eb6667384d8879a597c7b934020505429df74f06c6edcd/jupyterlab_server-2.1.2.tar.gz
...
%prep
%setup -q -n jupyterlab_server-2.1.2
cd %{_builddir}/jupyterlab_server-2.1.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1610505768
...
cp %{_builddir}/jupyterlab_server-2.1.2/LICENSE %{buildroot}/usr/share/package-licenses/jupyterlab_server/5c2668cefc1e214f589e49594127f9f79574de44
