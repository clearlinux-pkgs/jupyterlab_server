...
Version  : 1.1.3
Release  : 21
URL      : https://files.pythonhosted.org/packages/79/a2/5abc7ee813839b193b9f32098dcc418abef37cd1ef85d6c7d6e60dd40941/jupyterlab_server-1.1.3.tar.gz
Source0  : https://files.pythonhosted.org/packages/79/a2/5abc7ee813839b193b9f32098dcc418abef37cd1ef85d6c7d6e60dd40941/jupyterlab_server-1.1.3.tar.gz
...
%prep
%setup -q -n jupyterlab_server-1.1.3
cd %{_builddir}/jupyterlab_server-1.1.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1589209912
...
cp %{_builddir}/jupyterlab_server-1.1.3/LICENSE %{buildroot}/usr/share/package-licenses/jupyterlab_server/8cd4cef90d28bff5235d6343a8158b70a0668dc4
