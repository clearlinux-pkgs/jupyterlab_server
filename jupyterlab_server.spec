...
Source0  : https://files.pythonhosted.org/packages/2f/dd/2f87cebca3470c0106cca1dbfac2b47ed6b7c0f653aef89a7cdd8c30e839/jupyterlab_server-2.7.2.tar.gz
...
%prep
%setup -q -n jupyterlab_server-2.7.2
cd %{_builddir}/jupyterlab_server-2.7.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1629737091
...
cp %{_builddir}/jupyterlab_server-2.7.2/LICENSE %{buildroot}/usr/share/package-licenses/jupyterlab_server/5c2668cefc1e214f589e49594127f9f79574de44
