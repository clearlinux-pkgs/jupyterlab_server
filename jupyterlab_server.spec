...
Source0  : https://files.pythonhosted.org/packages/65/01/bdae39353219afc9522eabbb5b88ec7b140714c5ba337c6fed8ae42b18dd/jupyterlab_server-2.5.1.tar.gz
...
%prep
%setup -q -n jupyterlab_server-2.5.1
cd %{_builddir}/jupyterlab_server-2.5.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1620658437
...
cp %{_builddir}/jupyterlab_server-2.5.1/LICENSE %{buildroot}/usr/share/package-licenses/jupyterlab_server/5c2668cefc1e214f589e49594127f9f79574de44
