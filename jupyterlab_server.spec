...
Source0  : https://files.pythonhosted.org/packages/4c/32/6255b553c5d4435b5d6319ba8703f078c27fffac294f4a115ba68ec68304/jupyterlab_server-2.1.1.tar.gz
...
%prep
%setup -q -n jupyterlab_server-2.1.1
cd %{_builddir}/jupyterlab_server-2.1.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1610207553
...
cp %{_builddir}/jupyterlab_server-2.1.1/LICENSE %{buildroot}/usr/share/package-licenses/jupyterlab_server/5c2668cefc1e214f589e49594127f9f79574de44
