...
%prep
%setup -q -n jupyterlab_server-1.0.7
cd %{_builddir}/jupyterlab_server-1.0.7
...
cp %{_builddir}/jupyterlab_server-1.0.7/LICENSE %{buildroot}/usr/share/package-licenses/jupyterlab_server/8cd4cef90d28bff5235d6343a8158b70a0668dc4
