...
Source0  : https://files.pythonhosted.org/packages/43/9b/960e97a2d5fbf61c289afcd5493ad8dd3d3dce07e490167479b31ed061f4/jupyterlab_server-2.1.3.tar.gz
...
%prep
%setup -q -n jupyterlab_server-2.1.3
cd %{_builddir}/jupyterlab_server-2.1.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1611764177
...
cp %{_builddir}/jupyterlab_server-2.1.3/LICENSE %{buildroot}/usr/share/package-licenses/jupyterlab_server/5c2668cefc1e214f589e49594127f9f79574de44
