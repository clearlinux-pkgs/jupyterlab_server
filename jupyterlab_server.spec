...
Version  : 2.5.0
Release  : 42
URL      : https://files.pythonhosted.org/packages/2e/fa/b25fbec19d55998886087ceeef60785a1cdeccf999e5d3d431e585d42a1b/jupyterlab_server-2.5.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/2e/fa/b25fbec19d55998886087ceeef60785a1cdeccf999e5d3d431e585d42a1b/jupyterlab_server-2.5.0.tar.gz
...
%prep
%setup -q -n jupyterlab_server-2.5.0
cd %{_builddir}/jupyterlab_server-2.5.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1619462648
...
cp %{_builddir}/jupyterlab_server-2.5.0/LICENSE %{buildroot}/usr/share/package-licenses/jupyterlab_server/5c2668cefc1e214f589e49594127f9f79574de44
