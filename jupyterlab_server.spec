...
Source0  : https://files.pythonhosted.org/packages/29/66/28a5a5cf42762cbc0e4c57b21c55791d49f962ac3eb67c40d6e5019c1a67/jupyterlab_server-2.4.0.tar.gz
...
%prep
%setup -q -n jupyterlab_server-2.4.0
cd %{_builddir}/jupyterlab_server-2.4.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1617213853
...
cp %{_builddir}/jupyterlab_server-2.4.0/LICENSE %{buildroot}/usr/share/package-licenses/jupyterlab_server/5c2668cefc1e214f589e49594127f9f79574de44
