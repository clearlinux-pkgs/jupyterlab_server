...
Source0  : https://files.pythonhosted.org/packages/45/88/4f6de1a5bb6f668a65eb806f1f05392a5ead2eb6781949cbbc8c9f0c3740/jupyterlab_server-2.5.2.tar.gz
...
%prep
%setup -q -n jupyterlab_server-2.5.2
cd %{_builddir}/jupyterlab_server-2.5.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1621265191
...
cp %{_builddir}/jupyterlab_server-2.5.2/LICENSE %{buildroot}/usr/share/package-licenses/jupyterlab_server/5c2668cefc1e214f589e49594127f9f79574de44
