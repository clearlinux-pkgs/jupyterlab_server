...
%prep
%setup -q -n jupyterlab_server-2.6.1
cd %{_builddir}/jupyterlab_server-2.6.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1625848992
...
cp %{_builddir}/jupyterlab_server-2.6.1/LICENSE %{buildroot}/usr/share/package-licenses/jupyterlab_server/5c2668cefc1e214f589e49594127f9f79574de44
