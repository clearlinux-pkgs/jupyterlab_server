...
Source0  : https://files.pythonhosted.org/packages/9c/07/72cba43dba5d76edd6ba9552253628cca69f53b7246d0a71a7e22a870d65/jupyterlab_server-1.1.5.tar.gz
...
%prep
%setup -q -n jupyterlab_server-1.1.5
cd %{_builddir}/jupyterlab_server-1.1.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1590371883
...
cp %{_builddir}/jupyterlab_server-1.1.5/LICENSE %{buildroot}/usr/share/package-licenses/jupyterlab_server/8cd4cef90d28bff5235d6343a8158b70a0668dc4
