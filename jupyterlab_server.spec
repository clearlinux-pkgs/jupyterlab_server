...
%prep
%setup -q -n jupyterlab_server-1.1.0
cd %{_builddir}/jupyterlab_server-1.1.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1585674962
...
cp %{_builddir}/jupyterlab_server-1.1.0/LICENSE %{buildroot}/usr/share/package-licenses/jupyterlab_server/8cd4cef90d28bff5235d6343a8158b70a0668dc4
