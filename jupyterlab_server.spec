...
Version  : 1.1.4
Release  : 22
URL      : https://files.pythonhosted.org/packages/d4/82/39aee970c2a7c99cb52d2006e2d87c5f0b4111409383005a7472c8457d6e/jupyterlab_server-1.1.4.tar.gz
Source0  : https://files.pythonhosted.org/packages/d4/82/39aee970c2a7c99cb52d2006e2d87c5f0b4111409383005a7472c8457d6e/jupyterlab_server-1.1.4.tar.gz
...
%prep
%setup -q -n jupyterlab_server-1.1.4
cd %{_builddir}/jupyterlab_server-1.1.4
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1589846890
...
cp %{_builddir}/jupyterlab_server-1.1.4/LICENSE %{buildroot}/usr/share/package-licenses/jupyterlab_server/8cd4cef90d28bff5235d6343a8158b70a0668dc4
