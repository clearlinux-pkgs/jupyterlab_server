...
Source0  : https://files.pythonhosted.org/packages/3d/e2/b4b1ed4d3da9ad8063ed5eb56d8bbfccff6e0eee10614a8a89ed4ea1393d/jupyterlab_server-2.3.0.tar.gz
...
%prep
%setup -q -n jupyterlab_server-2.3.0
cd %{_builddir}/jupyterlab_server-2.3.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1614013618
...
cp %{_builddir}/jupyterlab_server-2.3.0/LICENSE %{buildroot}/usr/share/package-licenses/jupyterlab_server/5c2668cefc1e214f589e49594127f9f79574de44
