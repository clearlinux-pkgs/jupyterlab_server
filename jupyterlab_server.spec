...
Source0  : https://files.pythonhosted.org/packages/0b/2e/c7935cf8bf13a5766e96277f7ccf051d1f1bf6d7aef7be87e2ed70c71a20/jupyterlab_server-2.6.2.tar.gz
...
%prep
%setup -q -n jupyterlab_server-2.6.2
cd %{_builddir}/jupyterlab_server-2.6.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1628090239
...
cp %{_builddir}/jupyterlab_server-2.6.2/LICENSE %{buildroot}/usr/share/package-licenses/jupyterlab_server/5c2668cefc1e214f589e49594127f9f79574de44
